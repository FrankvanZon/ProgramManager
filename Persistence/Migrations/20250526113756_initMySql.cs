        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MilestoneID = table.Column<double>(type: "float", nullable: false),
                    ProgramStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    InnovationType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LaunchClassification = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartQuarter = table.Column<double>(type: "float", nullable: false),
                    FinishQuarter = table.Column<double>(type: "float", nullable: false),
                    Complexity = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FteRunRate = table.Column<double>(type: "float", nullable: false),
                    PhaseCost = table.Column<double>(type: "float", nullable: false),
                    Capex = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MilestoneRefId = table.Column<double>(type: "float", nullable: false),
                    Target = table.Column<double>(type: "float", nullable: false),
                    Realized = table.Column<double>(type: "float", nullable: false),
                    OnTime = table.Column<double>(type: "float", nullable: false),
                    ProjectPhaseId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
